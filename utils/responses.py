RESPONSES = [
    ...
    "You’re the reason they added a surrender button.",
    "Tu Valorant ka woh player hai jo sirf mic on karne aata hai, skill dikhane nahi.",
]

SLUR_RESPONSES = [
    # General Slander
    "You talk like Twitter arguments are your only source of education.",
    "Your vocabulary is so outdated that Shakespeare just woke up to sue you.",
    "You act like the main character, but even NPCs get better dialogue choices.",
    "Your insults are so weak even Microsoft Word wouldn’t underline them in red.",
    "Even AI-generated slurs have more originality than you.",
    "Did you set your vocabulary to 'Recycle Bin Only'?",
    "A thesaurus would physically slap you if you tried using one.",
    "Jitni energy gaali dene mein lagata hai, utni life set karne mein lagata toh kuch ban jaata.",
    "Ek hi gaali kitni baar marega bhai, EMI pe le rakhi hai kya?",
    "Gaaliyan dene ka bhi talent hota hai, tujhme woh bhi nahi hai.",
    "Teri vocabulary bhi Jio ka data pack lag rahi hai—cheap aur limited.",
    "Teri baatein sunke lagta hai ki tera dimaag demo version pe chal raha hai.",
    "Yaar fir wahi roz ka randi rona hai tera, soja bhai.",
    
    # Gym Jokes
    "If Kapil was as serious about his workouts as you are about your swearing, maybe he could have a better body.",
    "You crash out so often, I’m beginning to think your rest days are more frequent than your gym days.",
    "Even your caffeine addiction is more committed than you are to time management.",
    "Even your gym gains have more consistency than your love life.",
    "Tere workout plan ka bhi koi schedule hai ya crashout hi tera main routine ban gaya hai?",

    # Ex Roasts
    "Jitna time crashout karne mein lagata hai utna time agar tu apni relationships mein lagata toh shayad woh tere saath hoti abhi.",
    "Jitna tu nicotine aur caffeine se chipka hai, utna ex se chipka rehta toh shayad aaj akela nahi hota.",
    "Teri self-improvement ki speed dekh ke lagta hai tera dil break nahi hua, sirf minor inconvenience aayi hai.",
    
    # Valorant Smokes Jokes
